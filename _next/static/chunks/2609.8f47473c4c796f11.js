"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[2609],{12609:(e,t,a)=>{a.r(t),a.d(t,{W3mWalletReceiveView:()=>k});var r=a(1850),i=a(58446),o=a(12689),s=a(85859),n=a(71722),c=a(82570),l=a(11464),d=a(90889),u=a(51105),w=a(21159),p=a(44458);a(94213),a(23456),a(56349),a(53059),a(18341);var h=a(54684),g=a(51127);let v=(0,r.AH)`
  button {
    display: flex;
...
`;var b=function(e,t,a,r){var i,o=arguments.length,s=o<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,a):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,a,r);else for(var n=e.length-1;n>=0;n--)(i=e[n])&&(s=(o<3?i(s):o>3?i(t,a,s):i(t,a))||s);return o>3&&s&&Object.defineProperty(t,a,s),s};let m=class extends r.WF{constructor(){super(...arguments),this.networkImages=[""],this.text=""}render(){return(0,r.qy)`
      <button>
    ...
    </wui-flex>`}};m.styles=[h.W5,h.fD,v],b([(0,i.MZ)({type:Array})],m.prototype,"networkImages",void 0),b([(0,i.MZ)()],m.prototype,"text",void 0),m=b([(0,g.E)("wui-compatible-network")],m),a(85479),a(82780),a(60347);var f=a(36421);let y=(0,r.AH)`
...
`;var x=function(e,t,a,r){var i,o=arguments.length,s=o<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,a):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,a,r);else for(var n=e.length-1;n>=0;n--)(i=e[n])&&(s=(o<3?i(s):o>3?i(t,a,s):i(t,a))||s);return o>3&&s&&Object.defineProperty(t,a,s),s};let k=class extends r.WF{constructor(){super(),this.unsubscribe=[],this.address=s.U.state.address,this.profileName=s.U.state.profileName,this.network=n.W.state.activeCaipNetwork,this.preferredAccountTypes=s.U.state.preferredAccountTypes,this.unsubscribe.push(s.U.subscribe(e=>{e.address?(this.address=e.address,this.profileName=e.profileName,this.preferredAccountTypes=e.preferredAccountTypes):c.P.showError("Account not found")}),n.W.subscribeKey("activeCaipNetwork",e=>{e?.id&&(this.network=e)}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){if(!this.address)throw Error("w3m-wallet-receive-view: No account provided");let e=l.$.getNetworkImage(this.network);return(0,r.qy)` <wui-flex
    ...
    </wui-flex>`}networkTemplate(){let e=n.W.getAllRequestedCaipNetworks(),t=n.W.checkIfSmartAccountEnabled(),a=n.W.state.activeCaipNetwork,i=e.filter(e=>e?.chainNamespace===a?.chainNamespace);if(this.preferredAccountTypes?.[a?.chainNamespace]===f.Vl.ACCOUNT_TYPES.SMART_ACCOUNT&&t)return a?(0,r.qy)`<wui-compatible-network
